...
namespace FinalYearProject.Infrastructure.Migrations
{
    ...
    [Migration("20240213114858_DbChangesMigration8")]
    partial class DbChangesMigration8
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinalYearProject.Infrastructure.Data.Entities.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsoCode = "NG",
                            Name = "Nigeria",
                            TimeCreated = new DateTimeOffset(new DateTime(2024, 2, 13, 11, 48, 57, 685, DateTimeKind.Unspecified).AddTicks(4589), new TimeSpan(0, 0, 0, 0, 0)),
                            TimeUpdated = new DateTimeOffset(new DateTime(2024, 2, 13, 11, 48, 57, 685, DateTimeKind.Unspecified).AddTicks(4590), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("FinalYearProject.Infrastructure.Data.Entities.DataAggregatorUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountStatus = 1,
                            ConcurrencyStamp = "9ac3cad5-0409-42c5-a8b5-1cbd4dac0130",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEPsLgxDZoi85n2jE5oEc1GwtM/uYzQbIEy+/KVYV8g1BnrPh99qBjQ9LaDhhoc3IBw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "7679494FA435444E91D59BB3F5FD1B1A",
                            TimeCreated = new DateTimeOffset(new DateTime(2024, 2, 13, 11, 48, 57, 683, DateTimeKind.Unspecified).AddTicks(9776), new TimeSpan(0, 0, 0, 0, 0)),
                            TimeUpdated = new DateTimeOffset(new DateTime(2024, 2, 13, 11, 48, 57, 683, DateTimeKind.Unspecified).AddTicks(9781), new TimeSpan(0, 0, 0, 0, 0)),
