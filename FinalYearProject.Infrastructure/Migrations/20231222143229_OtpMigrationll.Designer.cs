            ...
            modelBuilder.Entity("FinalYearProject.Infrastructure.Data.Entities.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsoCode = "NG",
                            Name = "Nigeria",
                            TimeCreated = new DateTimeOffset(new DateTime(2023, 12, 22, 14, 32, 28, 303, DateTimeKind.Unspecified).AddTicks(2353), new TimeSpan(0, 0, 0, 0, 0)),
                            TimeUpdated = new DateTimeOffset(new DateTime(2023, 12, 22, 14, 32, 28, 303, DateTimeKind.Unspecified).AddTicks(2355), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("FinalYearProject.Infrastructure.Data.Entities.DataAggregatorUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountStatus = 1,
                            ConcurrencyStamp = "efdecf43-6053-4b9b-9a10-84f33e754bc8",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBftYu9tlchbOVWE0kOpMqYLY41ZeZVp6HCnzT2rI4B9Op5wtkattKKexwUpSRyDLw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "246C002F1E175A4D9573A6F15F84E4F5",
                            TimeCreated = new DateTimeOffset(new DateTime(2023, 12, 22, 14, 32, 28, 301, DateTimeKind.Unspecified).AddTicks(4535), new TimeSpan(0, 0, 0, 0, 0)),
                            TimeUpdated = new DateTimeOffset(new DateTime(2023, 12, 22, 14, 32, 28, 301, DateTimeKind.Unspecified).AddTicks(4540), new TimeSpan(0, 0, 0, 0, 0)),
