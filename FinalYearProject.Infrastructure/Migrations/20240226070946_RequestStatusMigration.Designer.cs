...
namespace FinalYearProject.Infrastructure.Migrations
{
    ...
    [Migration("20240226070946_RequestStatusMigration")]
    partial class RequestStatusMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinalYearProject.Infrastructure.Data.Entities.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsoCode = "NG",
                            Name = "Nigeria",
                            TimeCreated = new DateTimeOffset(new DateTime(2024, 2, 26, 7, 9, 45, 708, DateTimeKind.Unspecified).AddTicks(3672), new TimeSpan(0, 0, 0, 0, 0)),
                            TimeUpdated = new DateTimeOffset(new DateTime(2024, 2, 26, 7, 9, 45, 708, DateTimeKind.Unspecified).AddTicks(3675), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("FinalYearProject.Infrastructure.Data.Entities.DataAggregatorUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountStatus = 1,
                            ConcurrencyStamp = "2f75ac3a-073e-43b9-989e-eb3913164571",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEN1RsO1HUHvjSPtWpABEOeFuv+eJtMIf0ZBDrNosGI9OSY8nEHPnhGIJh5Q/bvSY6A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "7EBDB23E1407CE499095F288387A7255",
                            TimeCreated = new DateTimeOffset(new DateTime(2024, 2, 26, 7, 9, 45, 706, DateTimeKind.Unspecified).AddTicks(8542), new TimeSpan(0, 0, 0, 0, 0)),
                            TimeUpdated = new DateTimeOffset(new DateTime(2024, 2, 26, 7, 9, 45, 706, DateTimeKind.Unspecified).AddTicks(8547), new TimeSpan(0, 0, 0, 0, 0)),
