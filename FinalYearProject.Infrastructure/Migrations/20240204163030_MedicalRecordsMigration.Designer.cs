...
namespace FinalYearProject.Infrastructure.Migrations
{
    ...
    [Migration("20240204163030_MedicalRecordsMigration")]
            ...
            modelBuilder.Entity("FinalYearProject.Infrastructure.Data.Entities.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsoCode = "NG",
                            Name = "Nigeria",
                            TimeCreated = new DateTimeOffset(new DateTime(2024, 2, 4, 16, 30, 29, 832, DateTimeKind.Unspecified).AddTicks(8491), new TimeSpan(0, 0, 0, 0, 0)),
                            TimeUpdated = new DateTimeOffset(new DateTime(2024, 2, 4, 16, 30, 29, 832, DateTimeKind.Unspecified).AddTicks(8493), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("FinalYearProject.Infrastructure.Data.Entities.DataAggregatorUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountStatus = 1,
                            ConcurrencyStamp = "7600e992-1899-494a-9472-11be8ce74f3c",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEOzVgqVoEJQvpoA79+wH7bE+lOl96KxCRhY/3Ysf96beahKZCIDxtxOxcX6C2+5ekA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "1B12FFC51A189E4D8A969726C281156B",
                            TimeCreated = new DateTimeOffset(new DateTime(2024, 2, 4, 16, 30, 29, 831, DateTimeKind.Unspecified).AddTicks(2486), new TimeSpan(0, 0, 0, 0, 0)),
                            TimeUpdated = new DateTimeOffset(new DateTime(2024, 2, 4, 16, 30, 29, 831, DateTimeKind.Unspecified).AddTicks(2494), new TimeSpan(0, 0, 0, 0, 0)),
