...
namespace FinalYearProject.Infrastructure.Migrations
{
    ...
    [Migration("20240323235052_Requestupdate")]
            ...
            modelBuilder.Entity("FinalYearProject.Infrastructure.Data.Entities.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsoCode = "NG",
                            Name = "Nigeria",
                            TimeCreated = new DateTimeOffset(new DateTime(2024, 3, 23, 23, 50, 50, 934, DateTimeKind.Unspecified).AddTicks(8476), new TimeSpan(0, 0, 0, 0, 0)),
                            TimeUpdated = new DateTimeOffset(new DateTime(2024, 3, 23, 23, 50, 50, 934, DateTimeKind.Unspecified).AddTicks(8478), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("FinalYearProject.Infrastructure.Data.Entities.DataAggregatorUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountStatus = 1,
                            ConcurrencyStamp = "31f19f22-360d-45db-b9fa-d41a4935fdb9",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJA22WyOLU5mgjK5CO9A+6l8rCIopWn9BAGUBXX0a5ZehZkqdTyayNCb8TzXfC0Olw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "ABBB1230DB2971439D60CF0965B13A42",
                            TimeCreated = new DateTimeOffset(new DateTime(2024, 3, 23, 23, 50, 50, 933, DateTimeKind.Unspecified).AddTicks(2820), new TimeSpan(0, 0, 0, 0, 0)),
                            TimeUpdated = new DateTimeOffset(new DateTime(2024, 3, 23, 23, 50, 50, 933, DateTimeKind.Unspecified).AddTicks(2826), new TimeSpan(0, 0, 0, 0, 0)),
