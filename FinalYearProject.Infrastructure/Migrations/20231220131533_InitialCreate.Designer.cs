...
namespace FinalYearProject.Infrastructure.Migrations
{
    ...
    [Migration("20231220131533_InitialCreate")]
            ...
            modelBuilder.Entity("FinalYearProject.Infrastructure.Data.Entities.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsoCode = "NG",
                            Name = "Nigeria",
                            TimeCreated = new DateTimeOffset(new DateTime(2023, 12, 20, 13, 15, 31, 825, DateTimeKind.Unspecified).AddTicks(5559), new TimeSpan(0, 0, 0, 0, 0)),
                            TimeUpdated = new DateTimeOffset(new DateTime(2023, 12, 20, 13, 15, 31, 825, DateTimeKind.Unspecified).AddTicks(5561), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("FinalYearProject.Infrastructure.Data.Entities.DataAggregatorUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountStatus = 1,
                            ConcurrencyStamp = "6bc607d8-3643-4826-bf18-ab5724cfc550",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEHX4mhapxOsGtFvQq/gnLNxPzk0GDHtlz0SQ0SVVrb5gWGoQ8g4S/xEJxwesBynsHA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "A90D0351EF78674BBBA68CC5167775F1",
                            TimeCreated = new DateTimeOffset(new DateTime(2023, 12, 20, 13, 15, 31, 823, DateTimeKind.Unspecified).AddTicks(5285), new TimeSpan(0, 0, 0, 0, 0)),
                            TimeUpdated = new DateTimeOffset(new DateTime(2023, 12, 20, 13, 15, 31, 823, DateTimeKind.Unspecified).AddTicks(5290), new TimeSpan(0, 0, 0, 0, 0)),
